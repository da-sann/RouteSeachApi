...
namespace RouteSeachApi.Services {
    public class ProviderOneSearchService : IProviderOneSearchService {
        public ProviderOneSearchService(IRouteRepository routeRepository, IMapper mapper, ICacheService<IProviderOneSearchService, Guid, Route> cacheService, bool isAvaliable) {
        ...
        private readonly ICacheService<IProviderOneSearchService, Guid, Route> _cacheService;
